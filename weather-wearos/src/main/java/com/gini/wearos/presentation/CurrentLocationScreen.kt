...
//    )
    PermissionBox(
        permissions = emptyList(),// permissions,
        requiredPermissions = emptyList(),// listOf(permissions.first()),
        onGranted = {
...
fun CurrentLocationContent(usePreciseLocation: Boolean) {
    ...
    Column(
        ...
        Button(
            ...
            Log.d("TAG", "CurrentLocationContent: ${locationInfo}")
...
@Preview(device = androidx.wear.tooling.preview.devices.WearDevices.SQUARE)
@Composable
